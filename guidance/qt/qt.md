...
![](./imgs/installation0.png)

这里，直接选择 `Qt Design Studio` 和 `Qt 6.* for desktop development` 就可以了，之后就继续疯狂下一步。

![](./imgs/installation.png)

如果你的硬盘空间捉襟见肘，你可能得研究一下这里面哪些可以不装。上一步不改默认选项，下一步就会来到选择组件，选择一个 `Qt 6.*` 的版本打开下拉框，在里面选择你要的组件。
...
我们用 [QtNetworkDemo](hhttps://github.com/panjd123/QtNetworkDemo) 来演示怎么使用这套网络接口
